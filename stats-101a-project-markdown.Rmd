...
```{r}
summary(lm(happiness_data$Happy ~ factor(happiness_data$JobSat) + factor(happiness_data$Household) + factor(happiness_data$OwnHome) + happiness_data$Instagram + factor(happiness_data$Marital)))
```
